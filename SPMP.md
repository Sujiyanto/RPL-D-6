...
Asumsi Proyek :
 ...
 Substansi Proyek :
 - Aplikasi ini menyediakan fungsi sesuai kebutuhan mitra
 - Tersedia keahlian pokok dalam sistem yang akan dipakai
...
Proyek ini akan diimplementasikan dengan memanfaatkan metodologi  V Model. Teknik analisis berorientasi objek akan di gunakan untuk menyelesaikan proyek.<br>
...
|---------------|----------------|--------------|
|Laptop			|Sublime Text    |Internet		|
|				|Android Studio  |Hsoting Domain|
